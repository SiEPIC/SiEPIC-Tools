...
class Ring_Modulator_DB(pya.PCellDeclarationHelper):
    ...
    def produce_impl(self):
        ...
        self.cell.shapes(LayernN).insert(
            pya.Path(arc(r_n, angle_min_doping, angle_max_doping), w_1)
            .transformed(t)
            .simple_polygon()
        )
        ...
        self.cell.shapes(LayerpN).insert(
            pya.Path(arc(r_p, angle_min_doping, angle_max_doping), w_1)
            .transformed(t)
            .simple_polygon()
        )
        ...
        self.cell.shapes(LayernpN).insert(
            pya.Path(arc(r_np, angle_min_doping, angle_max_doping), w_1)
            .transformed(t)
            .simple_polygon()
        )
        ...
        self.cell.shapes(LayerppN).insert(
            pya.Path(arc(r_pp, angle_min_doping, angle_max_doping), w_1)
            .transformed(t)
            .simple_polygon()
        )
        ...
        self.cell.shapes(LayernppN).insert(
            pya.Path(arc(r_npp, angle_min_doping, angle_max_doping), w_2)
            .transformed(t)
            .simple_polygon()
        )
        ...
        # Create the P+ +Layer
        poly = (
            pya.Path(arc(r_ppp, angle_min_doping, angle_max_doping), w_2)
            .transformed(t)
            .simple_polygon()
        )
        ...
        self.cell.shapes(LayervcN).insert(
            pya.Path(arc(r_vc1, angle_min_VC, angle_max_VC), w_vc)
            .transformed(t)
            .simple_polygon()
        )

        poly = (
            pya.Path(arc(r_vc2, angle_min_VC, angle_max_VC), w_vc)
            .transformed(t)
            .simple_polygon()
        )
        self.cell.shapes(LayervcN).insert(
        ...
        self.cell.shapes(Layerm1N).insert(
            pya.Polygon(
                arc(w_m1_in, angle_min_doping, angle_max_doping) + [pya.Point(0, 0)]
            ).transformed(t)
        )
        self.cell.shapes(Layerm1N).insert(
            pya.Polygon(arc(w_m1_in / 2.0, 0, 360)).transformed(t)
        )
        self.cell.shapes(Layerm1N).insert(
            pya.Path(arc(r_m1_out, angle_min_M1, angle_max_M1), w_m1_out)
            .transformed(t)
            .simple_polygon()
        )
        boxM11 = pya.Box(
        ...
        self.cell.shapes(LayerPinRecN).insert(
            pya.Polygon(arc(r_vl, 0, 360)).transformed(t)
        )
        shapes(LayerPinRecN).insert(
            pya.Text("elec1a", pya.Trans(pya.Trans.R0, x0, y0))
        ).text_size = 0.5 / dbu
        shapes(LayerPinRecN).insert(
            pya.Box(x0 - w_via / 2, y0 - w_via / 2, x0 + w_via / 2, y0 + w_via / 2)
        )
        ...
        shapes(LayerPinRecN).insert(
            pya.Text(
                "elec1c",
                pya.Trans(
                    pya.Trans.R0, x0, y0 + r_vc2 + w_vc / 2 + 2.0 / dbu + h_via / 2
                ),
            )
        ).text_size = 0.5 / dbu
        # heater contacts
        ...
        self.cell.shapes(LayermhN).insert(
            pya.Path(arc(r_mh, angle_min_MH, angle_max_MH), w_mh)
            .transformed(t)
            .simple_polygon()
        )
        boxMH1 = pya.Box(
        ...
        shapes(LayerPinRecN).insert(
            pya.Path(
                [
                    pya.Point(x0 - (w_Si3 / 2.0 + taper_length) + pin_length / 2.0, 0),
                    pya.Point(x0 - (w_Si3 / 2.0 + taper_length) - pin_length / 2.0, 0),
                ],
                w,
            )
        ...
        shapes(LayerPinRecN).insert(
            pya.Text(
                "opt1", pya.Trans(pya.Trans.R0, x0 - (w_Si3 / 2.0 + taper_length), 0)
            )
        ).text_size = 0.5 / dbu
        ...
        shapes(LayerPinRecN).insert(
            pya.Text(
                "opt2", pya.Trans(pya.Trans.R0, x0 + (w_Si3 / 2.0 + taper_length), 0)
            )
        ).text_size = 0.5 / dbu
        ...
        shapes(LayerPinRecN).insert(
            pya.Text(
                "opt3",
                pya.Trans(pya.Trans.R0, x0 - (w_Si3 / 2.0 + taper_length), y_offset),
            )
        ).text_size = 0.5 / dbu
        ...
        shape = shapes(LayerDevRecN).insert(
            pya.Text(
        ...
        shapes(LayerDevRecN).insert(
            pya.Text("Component=Ring_Modulator_DB", pya.Trans(pya.Trans.R0, 0, w * 2))
        ).text_size = 0.3 / dbu
        shapes(LayerDevRecN).insert(
            pya.Text(
                "Component_ID=%s" % self.component_ID, pya.Trans(pya.Trans.R0, 0, w * 4)
            )
        ).text_size = 0.3 / dbu
        shapes(LayerDevRecN).insert(
            pya.Text(
