...
def example_circuit():
    ...
    instY2 = connect_cell(
        instGC2, "opt_wg", cell_ebeam_y, "pin1", relaxed_pinnames=True
    )
    ...
    connect_pins_with_waveguide(
        instY1, "2", instY2, "3", waveguide_type=waveguide_type, relaxed_pinnames=True
    )
    connect_pins_with_waveguide(
        instY1,
        "opt3",
    ...
    filename_netlist, filename_subckt = export_spice(
        cell, opt_in_selection_text=["opt_in_TE_1550_device_%s_MZI1" % designer_name]
    )
