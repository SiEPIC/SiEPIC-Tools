...
class Pin:
    ...
    def display(self):
        ...
        if p.component:
            ...
            print(
                "- pin_name %s: pin_type %s, rotation: %s, net: %s, (%s), path: %s"
...
class Component:
    ...
    def get_SPICE_params(
        self,
    ):  # Returns a SPICE parameter string (without the 'Spice_param:' label)
        return self.params
    ...
    def update(self):
        ...
        if 0:
            ...
            waveguide_types_simple = [
                t for t in waveguide_types if "compound_waveguide" not in t.keys()
            ]
